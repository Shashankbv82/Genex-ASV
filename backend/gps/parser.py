    ...
    try:
        ...
        if sentence_type == "RMC":
            ...
            if len(parts) > 2:
                ...
                gps_data.fix_valid = (status == "A")
                
                if len(parts) > 6 and gps_data.fix_valid:
        ...
        # ==================== GGA: Global Positioning System Fix Data ====================
            ...
            if len(parts) > 6:
                ...
                if len(parts) > 5 and gps_data.fix_quality > 0:
        ...
        # ==================== GSA: GNSS DOP and Active Satellites ====================
            ...
            if len(parts) >= 17:
                ...
                prns = [p for p in parts[3:15] if p.strip()]
                if prns:
                    gps_data.active_prns = prns
                try:
                    if parts[15]:
                        gps_data.pdop = round(float(parts[15]), 2)
                    if parts[16]:
                        gps_data.hdop = round(float(parts[16]), 2)
                    if len(parts) > 17 and parts[17]:
                        gps_data.vdop = round(float(parts[17].split("*")[0]), 2)
                except ValueError:
                    pass
